...
<div className="form-floating">
  ...
  <label for="floatingPassword">Password</label>
    ...
    <br/>
    <div className="form-floating">
  <input type="password" className="form-control" name="re_password" id="floatingRe_Password" placeholder="Confirm Password" onChange={e=>onChange(e)} required value={re_password} />
  <label for="floatingRe_Password">Confirm Password</label>
</div>
<br/>
</div>
